"""
Compute chromosome-specific budgets from sample data.

Input is the directory containing the `tracks_chr[]` output from `rocco prep`.
Output is a CSV file that can be supplied as the parameter file for `rocco gwide --param_file`
