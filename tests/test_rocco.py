...
wrap_run('python3 rocco.py chrom --chrom chr21 --wig_path tests/data/tracks_chr21 -b .02 -N 0 --outdir tests/output')
log('running ROCCO_chrom.py for chr22, store output in `tests/output`', sys.argv[0])
wrap_run('python3 rocco.py chrom --chrom chr22 --wig_path tests/data/tracks_chr22 -b .02 -N 0 --outdir tests/output')
...
wrap_run('python3 rocco.py gwide -p tests/test_params.csv --outdir tests/output/combined --combine tests/combined.bed -N 0 --multi')
